...
import { ArrowRight, Play, Star, TrendingUp, Menu, X } from "lucide-react";
...
if (
  ...
  !document.getElementById("transitions-p11")
) {
...
const HeaderAndHero = () => {
  ...
  const avatarNodes = [
    <div className="avatar premium-shadow">
      <img src="https://i.pravatar.cc/100?img=22" alt="User 1" />
    </div>,
    <div className="avatar premium-shadow">
      <img src="https://i.pravatar.cc/100?img=23" alt="User 2" />
    </div>,
    <div className="avatar premium-shadow">
      <img src="https://i.pravatar.cc/100?img=24" alt="User 3" />
    </div>,
    <div className="avatar premium-shadow">
      <img src="https://i.pravatar.cc/100?img=25" alt="User 4" />
    </div>,
  ];
          ...
          <div className="logo-container">
            ...
            <div className="logo-text">
              <span className="brand-name">
                Just<span className="brand-highlight">Bloom</span>
              </span>
      ...
      <section id="home" className="hero-section hero-enter-anim">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            We Grow Brands.
            <br />
            You Just <span className="text-gradient">Bloom</span>.
          </h1>
          <p className="hero-subtitle">
            From elite shooting & editing to hyper-targeted Meta & Google Ads
            campaigns. We architect digital growth that breaks the algorithm.
          </p>
          ...
          <div className="social-proof">
            ...
            <span className="social-text">
              Join <span className="text-bold-blue">50+ Happy Clients</span>
            </span>
          ...
          <TiltWrapper>
            ...
            <div className="float-card card-meta frosted-glass">
              <div className="card-header">
                <span className="card-title">Meta Ads</span>
            ...
            <div className="float-card card-google frosted-glass">
              <div className="card-header">
                <span className="card-title">Google Ads</span>
