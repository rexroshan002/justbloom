      ...
      <div className="cta-banner-wrapper">
        <div className="cta-banner premium-mesh-cta">
          <div className="cta-left">
            <div className="cta-icon-box glass-orb">
          ...
          <button
            className="cta-btn premium-invert-btn"
            onClick={handleConsultationClick}
          >
            <span>Get Free Consultation</span>{" "}
            <ArrowRight size={18} className="kinetic-arrow" />
          </button>
        </div>
      </div>
      ...
      <div className="main-footer">
          ...
          <div className="footer-logo">
            ...
            <div className="footer-logo-text">
              <span className="brand-name">
                Just<span className="text-gradient">Bloom</span>
              </span>
              <span className="brand-tagline">Where Brands Bloom</span>
            </div>
          </div>
          <p className="footer-desc">
            Helping elite businesses scale with high-fidelity creative content,
            weaponized advertising, and result-driven strategy.
          </p>
          <p className="footer-copyright">
            © 2026 JustBloom. All Rights Reserved.
          </p>
        </div>
        ...
        <div className="footer-col">
          ...
          <div className="footer-socials">
            ...
            <a href="#" aria-label="X" className="magnetic-social">
              <SocialIcon type="twitter" />
            </a>
            <a href="#" aria-label="Instagram" className="magnetic-social">
              <SocialIcon type="instagram" />
            </a>
            <a href="#" aria-label="YouTube" className="magnetic-social">
